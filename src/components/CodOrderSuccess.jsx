...
export default function SuccessPage() {
  ...
  useEffect(() => {
    ...
    if (!orderId || !status || !total) {
      console.error("Missing order parameters");
      router.push("/");
      return;
    }

    setOrderDetails({ orderId, status, total });
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <div
                    className={`p-2 rounded-full ${
                      orderDetails.status === "completed" ? "bg-green-100" : "bg-yellow-100"
                    }`}
                  >
                ...
                <div className="text-right">
                  ...
                  <p className="text-3xl font-bold text-gray-900">৳ {orderDetails.total}</p>
                </div>
              </div>
