          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                {Math.round((regularCustomers.length / allUsers.length) * 100)}%
                of total
              </p>
            </div>
              ...
              {currentCustomers.map((user) => (
                ...
                >
                  <td className="py-4 px-6">
                    <input
                      type="checkbox"
                      checked={selectedCustomers.includes(user._id || user.id)}
                      onChange={() =>
        ...
        {currentCustomers.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">
              No {activeTab === "regular" ? "regular users" : "administrators"}{" "}
              found
            </h3>
        ...
        <div className="px-6 py-4 border-t border-gray-200 bg-gray-50">
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-4 lg:space-y-0">
            <p className="text-sm text-gray-700">
              ...
              <span className="font-medium">{currentCustomers.length}</span> of{" "}
