      ...
      <div className="text-center text-gray-500">
        ...
        <div className="mt-4 p-4 bg-gray-50 rounded-lg">
          <div className="flex items-end justify-center space-x-2 h-32">
            {[40, 60, 75, 55, 80, 65, 90, 70, 85, 95, 80, 75].map((height, index) => (
              <div
                key={index}
  ...
  return (
    <div className="h-80">
      ...
      <div className="mt-6 p-4 bg-gray-50 rounded-lg text-center">
        <p className="text-sm text-gray-600">Category distribution by sales volume</p>
      </div>
    </div>
  );
};
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-2">
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Revenue Analytics</h2>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-2">
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Category Distribution</h2>
            <select className="border border-gray-300 rounded-lg px-3 py-2 text-sm w-full sm:w-auto">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200 xl:col-span-2">
          ...
          <div className="space-y-3">
            {recentOrders.map((order) => (
              <div key={order.id} className="flex flex-col sm:flex-row sm:items-center justify-between p-3 sm:p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors gap-2">
                <div className="flex-1">
                ...
                <div className="flex items-center justify-between sm:justify-end gap-4">
                  ...
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${order.statusColor} whitespace-nowrap`}>
                    {order.status}
                  </span>
                </div>
              </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-lg sm:text-xl font-semibold text-gray-900">Recent Registrations</h2>
            <button className="text-green-600 hover:text-green-700 text-sm font-medium">
              View All
            </button>
          </div>
          <div className="space-y-3">
            {recentRegistrations.map((user) => (
              <div key={user.id} className="flex flex-col sm:flex-row sm:items-center justify-between p-3 sm:p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors gap-2">
                <div className="flex-1">
            ...
            <tbody>
              {topSellingProducts.map((product) => (
                <tr key={product.id} className="border-b border-gray-100 hover:bg-gray-50 transition-colors">
                  ...
                  <td className="py-4 font-semibold text-green-600">{product.revenue}</td>
                  <td className="py-4">
