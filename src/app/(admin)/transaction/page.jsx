...
const Transaction = () => {
    ...
    const { 
        ...
        queryFn: async () => {
            const res = await instance.get(`/transactions?page=${currentPage}&limit=${limit}`);
            return res.data
        },
                        ...
                        <>
                                        ...
                                        {transactions.map((transaction) => (
                                            <tr key={transaction._id} className="hover:bg-gray-50 transition-colors duration-150">
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="text-sm font-mono text-gray-900">{transaction.tran_id}</div>
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="text-sm font-mono text-gray-900">{transaction.orderId}</div>
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="text-sm font-medium text-gray-900">{transaction.payment_method}</div>
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="text-sm font-medium text-gray-900">{transaction.card_brand}</div>
                                                    <div className="text-sm text-gray-500">{transaction.card_issuer}</div>
                                                </td>
                                                <td className="px-6 py-4 whitespace-nowrap">
                            ...
                            {transactions.length === 0 && !isLoading && (
                                <div className="text-center py-12">
                                    ...
                                    <p className="mt-1 text-sm text-gray-500">No transactions found in the system.</p>
                                </div>
                            )}
                        </>
                    )}
