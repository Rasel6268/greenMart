                    ...
                    <li key={index}>
                      <a
                        ...
                        className={`flex justify-between items-center rounded-xl px-4 py-3 cursor-pointer transition-all duration-300 ${
                          category.active
                            ? "bg-linear-to-r from-green-500 to-emerald-600 text-white shadow-lg transform -translate-y-0.5"
                  ...
                  <div className="grid grid-cols-4 gap-4">
                    {[
                      ...
                      >
                        <Image
                          src={brand}
                          width={32} // or appropriate width
                          height={32} // or appropriate height
